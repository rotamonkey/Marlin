...
#define STRING_CONFIG_H_AUTHOR "(awallace, Ender 5, BTT SKR 1.4)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender 5 SKR Hemera"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -47, 6, -2.87 }
